// The canonical plan shapes. Both the planner and the API import these from here;
// `web/src/interfaces/planner/FactoryInterface.ts` is a re-export of this file.

/** An ingredient or byproduct line on a power recipe. */
