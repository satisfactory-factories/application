...
| `tab-lifecycle` | Create, rename, delete and drag-reorder all reach a second device once it opens the plan from the panel; a hidden plan stays hidden across a reload and Show restores it; a member is offered no rename. |
