  ...
  <v-dialog max-width="1200" :model-value="openTutorial" scrollable>
    <v-card>
      ...
      <v-card-text class="verbage">
        ...
        <img alt="Editing a building group and watching the item's quantity update automatically" class="tutorial-gif" src="/assets/tutorials/building-groups-sync.gif">
        ...
        <img alt="Adding Somersloops to a building group and watching power usage and output rise" class="tutorial-gif" src="/assets/tutorials/building-groups-somersloops.gif">
