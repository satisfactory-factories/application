    ...
    <v-row>
      <v-col ref="content" cols="12">
        ...
        <ul class="ml-6 mt-2">
          ...
          <li><b>Eight statuses to start with.</b> Red: shortage, unmet export request, building groups that don't add up. Amber: unhandled byproduct, out of sync with the game, redundant import, duplicate import. Note: no demand.</li>
          ...
          <li><b>An unhandled byproduct is amber, and it does colour the factory.</b> A byproduct nothing consumes has nowhere to go, so it fills the machine's output slot and stops the buildings making it. You can decline to build a product nobody wants; you cannot decline the Plutonium Waste that comes off a Plutonium Fuel Rod line. Fluids are the hard case, having no sink of their own. The product or generator responsible takes an amber background so you can see which row it is, and exporting the byproduct or blending it into a recipe clears it.</li>
