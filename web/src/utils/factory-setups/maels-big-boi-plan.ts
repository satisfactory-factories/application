...
const bigBoiPlan: Factory[] = [{
  ...
  displayOrder: 29,
  tasks: [],
  notes: 'Three unfueled Alien Power Augmenters: 500 MW each plus a +10% grid boost per augmenter. Each costs 10 Somersloops to construct.\n\nPhase 5 Intermediates makes 4/min Alien Power Matrixes spare — a fueled augmenter needs 5/min, so bump that clock if you want to toggle a group to Supply Matrixes for +30%.',
  powerProducers: [{
  ...
  power: { consumed: 0, produced: 1500, difference: 1500 },
  previousInputs: [],
  dataVersion: '2025-02-20',
  syncStatePower: {},
}, {
  ...
  displayOrder: 30,
  tasks: [],
  notes: 'Geothermal Generators are fuel-less — one producer per geyser purity (Impure 100 MW, Normal 200 MW, Pure 400 MW average per generator), each oscillating between 0.5x and 1.5x of the average.',
  powerProducers: [{
  ...
  power: { consumed: 0, produced: 1800, difference: 1800 },
  previousInputs: [],
  dataVersion: '2025-02-20',
  syncStatePower: {},
}]
